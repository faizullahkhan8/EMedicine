        ...
        <>
            <div className="flex flex-col gap-2 w-[95%]">
                ...
                <div className="flex gap-4 flex-col">
                    {/* Header Medicine */}
                    <div className="border rounded p-4 dark:bg-transparent">
                        <div className="flex gap-2 flex-col">
                            ...
                            <div className="flex justify-start gap-3">
                                ...
                                <p className="line-through text-red-500 text-sm font-semibold text-[12px] ">
                                    <span>Rs:</span> {topOneItem.estimatedPrice}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full gap-4 grid grid-cols-2">
                        {updatedData.map((item, index) => (
                            <div
                                key={index}
                                className="border flex w-full rounded dark:bg-transparent p-4"
                            >
                                <div>
                                    <div>
                                        <Image
