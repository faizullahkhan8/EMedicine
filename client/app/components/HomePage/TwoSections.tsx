        ...
        <div className="w-full flex justify-center flex-col my-4">
            ...
            <div className="grid grid-cols-2 max-800px:grid-cols-1 gap-4">
                {items.map((item, index) => (
                    <div
                        key={index}
                        className="flex gap-2 my-2 shadow-lg dark:shadow-white rounded-lg"
                    >
                        {/* info section */}
                        <div className="w-[50%] max-800px:w-[80%] flex flex-col p-2 justify-between">
                            ...
                            <div className="group">
                                <MdArrowForward className="text-[28px] group-hover:translate-x-3 transition-transform group-hover:text-blue-700 duration-500" />
                            </div>
                        </div>
                        {/* image section */}
